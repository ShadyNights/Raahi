...
const SOSComponent = ({ onBack }) => {
  ...
  if (sosActivated) {
    return (
      <div className="h-full overflow-y-auto bg-gradient-to-b from-[#FF4444] to-[#CC2222] text-white" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
        {/* Header */}
        <div className="flex items-center justify-between p-4 pt-6 sticky top-0 bg-gradient-to-b from-[#FF4444] to-[#CC2222] z-10">
  ...
  return (
    <div className="h-full overflow-y-auto bg-gradient-to-b from-[#FF6B35] to-[#FF4500] text-white" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
      {/* Sticky Header */}
      <div className="sticky top-0 bg-gradient-to-b from-[#FF6B35] to-[#FF4500] z-10 p-4 pt-6">
        ...
        <h1 className="text-2xl font-bold text-white mb-6">SOS - Trigger Emergency</h1>
      </div>
      ...
      <div className="px-6 pb-24">
        ...
        <div className="mt-8 bg-white/10 rounded-lg p-4">
          <h3 className="text-white font-semibold mb-3">Safety Instructions</h3>
